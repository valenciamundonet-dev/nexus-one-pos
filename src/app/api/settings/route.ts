...
export async function PUT(req: NextRequest) {
  try {
    ...
    const updateData: any = {
      ...
      ticketHeaderFontSize: parseInt(body.ticketHeaderFontSize) || 0,
      ticketShowInvoiceId: body.ticketShowInvoiceId !== false,
      ticketInvoiceIdAlign: body.ticketInvoiceIdAlign || 'center',
      ticketLineSpacing: parseFloat(body.ticketLineSpacing) || 1.0,
      ticketColSpacing: parseFloat(body.ticketColSpacing) || 1.0,
      ticketBodyFontSize: parseInt(body.ticketBodyFontSize) || 0,
      ticketItemFontSize: parseInt(body.ticketItemFontSize) || 0,
      ticketTotalFontSize: parseInt(body.ticketTotalFontSize) || 0,
      ticketFooterFontSize: parseInt(body.ticketFooterFontSize) || 0,
      ticketRifFontSize: parseInt(body.ticketRifFontSize) || 0,
      ticketAddressFontSize: parseInt(body.ticketAddressFontSize) || 0,
