          ...
          <CardContent className="p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-yellow-700 mt-1">
                  Prueba NexusOne POS con funciones basicas. Al activar una licencia BASICA o PROFESIONAL
          ...
          <CardContent className="p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-red-700 mt-1">
                  Su licencia ha expirado. Active una nueva clave para continuar utilizando NexusOne POS.
