' Nexus One POS v2.9.83 - Instalador Profesional (FUSION)
'
...
' ---- Confirmacion ----
Dim bienvenida
bienvenida = "Nexus One POS v2.9.83" & vbCrLf & vbCrLf & _
...
If strDesktop <> "" And objFSO.FolderExists(strDesktop) Then
    ...
    If objFSO.FileExists(strDir & "\INICIAR-TODO-OCULTO.vbs") Then
        ...
        Else
            ...
            oLink.Description = "Nexus One POS v2.9.83 - Iniciar sistema"
...
MsgBox finale, vbInformation, "Nexus One POS v2.9.83"
